...
function renderGradientLines(content: React.ReactNode) {
  return (
    <>
...
function renderVariantDecoration(
  variant: CardProps["variant"],
  content: React.ReactNode,
) {
  if (variant === "gradient") return renderGradientLines(content)
  if (variant === "plus") return renderPlusIcons()
  if (variant === "corners") return renderCornerBorders()
  return null
}
  ...
  ({ className, variant, title, description, children, ...props }, ref) => {
    ...
    return (
      <div
        ...
        {...props}
      >
        {renderVariantDecoration(variant, content)}
        {content}
      </div>
    )
  },
