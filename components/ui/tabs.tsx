...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-lg border border-border bg-muted/70 p-0.5 text-muted-foreground/75",
      className,
    )}
    {...props}
  />
